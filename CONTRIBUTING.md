...
yeni reponu ekleyen bir PR gönder, böylece anasayfada listelenir. Canlı bir
uygulama ise footer menüsü için [public/assets/apps.json](public/assets/apps.json)
kaydı da gerekir.

### 8. Ortak shell

Header ve footer [tasarım kılavuzu](public/DESIGN.md)ndaki `shell.js` /
`shell.css` ile eklenir. Uygulama adı header’da yazılmaz; logo ana siteye gider.
